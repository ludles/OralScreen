inputFolder="D:/Materials/Office/OralCells/FCRN/PredMasks/"; //getDirectory("Choose input folder");
outputFolder="D:/Materials/Office/OralCells/FCRN/Results/"; //getDirectory("Choose output folder for the results");
